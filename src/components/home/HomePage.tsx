...
export function HomePage() {
  return (
    <main>
      <section className="relative isolate min-h-[720px] overflow-hidden bg-ink text-white sm:min-h-[780px]">
        ...
        <SiteHeader />
        <Container className="relative z-10 flex min-h-[720px] items-end pb-16 pt-32 sm:min-h-[780px] sm:pb-20 lg:pb-24">
          <div className="max-w-3xl">
            <p className="mb-6 text-[10px] font-bold uppercase tracking-[0.24em] text-dune sm:text-xs">Motorcycle adventure experiences</p>
            <h1 className="font-display text-[clamp(3.5rem,9vw,7.8rem)] leading-[0.86] tracking-[-0.065em]">Un viaggio non è una vacanza.</h1>
            <p className="mt-7 max-w-xl text-base leading-7 text-white/88 sm:text-lg">È qualcosa che ti cambia.</p>
            <a href="#esperienze" className="mt-9 inline-flex items-center gap-3 rounded-full bg-white px-6 py-4 text-xs font-bold uppercase tracking-[0.15em] text-ink shadow-[0_12px_35px_rgba(0,0,0,.22)] transition duration-300 hover:-translate-y-0.5 hover:bg-dune hover:shadow-[0_16px_38px_rgba(0,0,0,.3)]">Scopri i raid <ArrowIcon className="size-4" /></a>
          </div>
        </Container>
      </section>

      <section id="esperienze" className="scroll-mt-10 bg-canvas py-20 sm:py-28">
        <Container>
          <FadeIn className="max-w-2xl">
            <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-clay">Le destinazioni</p>
            <h2 className="mt-4 font-display text-5xl leading-[0.91] tracking-[-0.055em] text-ink sm:text-6xl">Tre destinazioni. Un solo modo di viverle: in moto.</h2>
          </FadeIn>
      ...
      <section className="overflow-hidden bg-sand">
        <Container className="grid min-h-[570px] items-center gap-12 py-20 lg:grid-cols-[1fr_1fr] lg:py-0">
          <FadeIn className="max-w-xl">
            ...
            <h2 className="mt-4 font-display text-5xl leading-[0.91] tracking-[-0.055em] sm:text-6xl">Il deserto non si guarda. Si attraversa.</h2>
      ...
      <section className="relative isolate overflow-hidden bg-sea py-24 text-white sm:py-32">
        ...
        <Container>
          <FadeIn className="max-w-3xl">
            ...
            <h2 className="mt-5 font-display text-6xl leading-[0.86] tracking-[-0.065em] sm:text-7xl">Il deserto non aspetta.</h2>
            <a href="/esperienze/tunisia-desert-experience" className="mt-9 inline-flex items-center gap-3 rounded-full bg-white px-6 py-4 text-xs font-bold uppercase tracking-[0.15em] text-ink shadow-[0_12px_35px_rgba(0,0,0,.22)] transition duration-300 hover:-translate-y-0.5 hover:bg-dune hover:shadow-[0_16px_38px_rgba(0,0,0,.3)]">Richiedi disponibilità <ArrowIcon className="size-4" /></a>
          </FadeIn>
        </Container>
      </section>
