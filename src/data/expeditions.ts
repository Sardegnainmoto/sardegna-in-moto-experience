...
export const tunisiaExpedition: Expedition = {
  ...
  gallery: [
    { src: "/images/tunisia/campo-tra-le-dune.png", alt: "Campo tendato ai piedi delle grandi dune del Sahara", size: "wide" },
    { src: "/images/tunisia/fuoco-nel-deserto.jpg", alt: "Fuoco acceso nel campo nel deserto al tramonto", size: "standard" },
    { src: "/images/tunisia/rientro-assistenza.jpg", alt: "Mezzo di assistenza durante il rientro nel deserto", size: "standard" },
    { src: "/images/tunisia/support-camp.png", alt: "Campo e assistenza al tramonto nel deserto", size: "wide" },
    { src: "/images/tunisia/riders-tra-le-dune.jpg", alt: "Gruppo di motociclisti tra le dune del Sahara", size: "wide" },
    { src: "/images/tunisia/oasi-ksar-ghilane.png", alt: "Oasi di Ksar Ghilane tra palme e acqua", size: "standard" },
